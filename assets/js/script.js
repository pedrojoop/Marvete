...
const timeStamp = '1679944271'
const keyPublica = '1e933803f9a764c4922f641f7e24b369'
const md5 = '1c435391159ff6ee699e5df4cd066ad0'
...
fetch(`https://gateway.marvel.com:443/v1/public/characters?ts=1679944271&apikey=1e933803f9a764c4922f641f7e24b369&hash=1c435391159ff6ee699e5df4cd066ad0&limit=40`
    ).then((response) => {
...
fetch(`https://gateway.marvel.com:443/v1/public/comics?ts=1679944271&apikey=1e933803f9a764c4922f641f7e24b369&hash=1c435391159ff6ee699e5df4cd066ad0`
    ).then((response) => {
        return response.json();        
    }).then((jsonParsed) => {
