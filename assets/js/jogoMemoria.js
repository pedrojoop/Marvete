...
fetch(`https://gateway.marvel.com:443/v1/public/characters?ts=1679944271&apikey=1e933803f9a764c4922f641f7e24b369&hash=1c435391159ff6ee699e5df4cd066ad0&limit=40&limit=30)`
    ).then((response) => {
...
function viraCostas(carta){
    carta.src = '/marvelCaracteres-main/assets/img/costasCarta.png'
}
